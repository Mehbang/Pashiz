...
export const AccountMeta = {
  ...
  fields: {
    ...
    root_type: {
      ...
      options: [
        { key: 'asset', label: 'account.root_type.asset' },
        { key: 'liability', label: 'account.root_type.liability' },
        { key: 'equity', label: 'account.root_type.equity' },
        { key: 'Income', label: 'account.root_type.income' },
        { key: 'expense', label: 'account.root_type.expense' },
      ],
