...
// The account type enums and the `ACCOUNT_TYPES` table were duplicated here,
// verbatim, and drifted the moment either copy was edited. They describe the
// shape of a chart of accounts rather than anything about this module, and two
// dozen modules outside it read them, so `@/constants/accounts` holds the only
// definition. What remains above is the seed chart, which is genuinely local.
